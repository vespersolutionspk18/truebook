        ...
        <div className="flex-1 px-3 py-2">
          <div className="flex flex-col gap-1.5">
            <div className="flex flex-col gap-1.5">
              ...
              <div
                className={cn(
                  "flex items-center w-full p-2 rounded-xl text-gray-800 border-gray-100 hover:bg-white border-[1px] hover:border-gray-300 hover:text-black hover:font-medium hover:shadow-sm cursor-pointer",
                  !expanded && "justify-center p-2"
                )}
              >
                <HiOutlineDocumentDuplicate className="h-5 w-5 stroke-gray-800 hover:stroke-black" />
                {expanded && <span className="ml-3 text-sm">Bookouts</span>}
              </div>
            </div>
